...
namespace prac4sharp
{
    public partial class MainWindow : Window
    {
        ...
        {
            Class1.serializ<List<MyClass>>(json_list, "C:\\Users\\alinaryzhkova\\source\\repos\\prac4sharp\\prac4sharp\\json_all.json");
        }
        private void deseril()
        {
            ...
            json_list.Clear();
            dela_today.Clear();
            json_list = Class1.deserializ<List<MyClass>>("C:\\Users\\alinaryzhkova\\source\\repos\\prac4sharp\\prac4sharp\\json_all.json");
